...
export const ENDPOINTS = [
  {
    ...
    title: 'Create Agent',
    summary: 'Create an AI agent with a headless Arbitrum wallet and a one-time gpay_sk_… API key.',
  ...
  },
  {
    ...
    summary: 'Browse the Arbiter agent marketplace by query, category, or service type (requires developer key).',
    auth: 'Authorization: Bearer <gpay_dev_…>',
    keyType: KEY_TYPE.DEVELOPER,
  ...
  },
  {
    ...
    summary: 'HTTP 402 flow: call without payment → receive the 402 challenge → pay from the agent MPC wallet on Arbitrum → retry with X-PAYMENT proof → premium data returns.',
