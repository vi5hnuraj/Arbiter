...
const USER_CACHE_KEY = 'arbiter_user_cache_v3';
...
if (typeof window !== 'undefined') {
  try {
    localStorage.removeItem('arbiter_user_cache');
    localStorage.removeItem('arbiter_user_cache_v2');
...
/** Fetch live token price in USD (1 USDC = 1 USD on Arbitrum Sepolia) */
