...
export const mpcChain = {
  chainId: Number(import.meta.env.VITE_CHAIN_ID || 421614),
  rpcUrl: import.meta.env.VITE_RPC_URL || "https://sepolia-rollup.arbitrum.io/rpc",
  explorerUrl: import.meta.env.VITE_EXPLORER_URL || "https://sepolia.arbiscan.io",
...
export const getActiveMpcWallet = () => {
  ...
  if (user) {
    ...
    if (address) {
      try {
        const raw = localStorage.getItem('arbiter_user_cache');
        if (raw) {
