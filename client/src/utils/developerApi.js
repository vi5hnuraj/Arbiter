...
export const developerApi = {
  ...
  // ---- Arbiter Workflow Studio (compose → review → dry-run → execute → prove) ----
  ...
  // Autonomous commerce includes wallet signing, Arbitrum confirmation, and Graph
  ...
  // ---- Arbiter demo endpoints (B2B engagement cycle + held panel) ----
