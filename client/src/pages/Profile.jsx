...
import { FaUserCircle, FaEdit, FaCheckCircle, FaSignOutAlt } from 'react-icons/fa';
...
const Profile = () => {
  ...
  const [globalPayTag, setArbiterTag] = useState("");
  ...
  // Live RPC balance query for both internal vault and external wallet on Arbitrum Sepolia
  useEffect(() => {
    import('ethers').then(async ({ ethers }) => {
      const rpc = import.meta.env.VITE_RPC_URL || 'https://sepolia-rollup.arbitrum.io/rpc';
          ...
          <div className="relative bg-[#0c0c0c]/80 backdrop-blur-xl border border-zinc-800/60 rounded-[2rem] p-5 sm:p-8 shadow-2xl overflow-hidden flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex justify-between items-center py-2 border-b border-zinc-800/40">
                  <span className="text-zinc-500 text-[10px] font-bold uppercase tracking-widest">Arbiter Tag</span>
                  {globalPayTag ? (
                  ...
                  <div>
                    ...
                    {isExtConnected ? (
                      <div className="flex items-center gap-2 mt-1 flex-wrap">
                        ...
                        <a
                          href={`${import.meta.env.VITE_EXPLORER_URL || 'https://sepolia.arbiscan.io'}/address/${activeExtWallet}`}
                          target="_blank"
                          rel="noreferrer"
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-amber-300 text-[10px]">USDC Native Gas · Arbitrum Sepolia</p>
                    </div>
                  </div>
                </div>
                <div className="text-right">
