              ...
              <div className="bg-zinc-950/60 border border-zinc-800/80 p-4 rounded-2xl">
                {user?.metamask ? (
                  ...
                  <div>
                    ...
                    <a href="/profile" className="text-xs font-bold text-white underline">Connect Web3 Wallet</a>
                  </div>
                )}
              </div>
            </div>
                  ...
                  transactions.slice(0, 10).map((t) => (
                    <tr key={t._id} className="group hover:bg-white/[0.01] transition-colors">
                      ...
                      <td className="px-4 sm:px-8 py-4 sm:py-6 text-right">
                        {t.txHash ? (
                          <a
                            href={`${import.meta.env.VITE_EXPLORER_URL || 'https://sepolia.arbiscan.io'}/tx/${t.txHash}`}
                            target="_blank"
                            rel="noreferrer"
