...
const CHANGELOG = [
  {
    version: '3.0.0',
    date: '2026-08-19',
    title: 'Arbiter V3 — AI Agent Commerce Platform',
    type: 'major',
    sections: [
      {
  ...
  return (
    <div>
      <header className="mb-6">
        ...
        <p className="text-sm text-zinc-500 mt-1">Version history and release notes for the Arbiter Developer Platform.</p>
      </header>
      ...
      <div className="mt-8 pt-6 border-t border-zinc-800">
        <div className="flex flex-wrap gap-3">
          ...
          <a
            href="https://github.com/arbiter/arbiter-platform/releases"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-4 py-2 border border-zinc-700 rounded-lg text-sm text-zinc-300 hover:border-blue-500 hover:text-blue-400 transition-colors"
          >
          ...
          <a
            href="https://github.com/arbiter/arbiter-platform/blob/main/CHANGELOG.md"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-4 py-2 border border-zinc-700 rounded-lg text-sm text-zinc-300 hover:border-blue-500 hover:text-blue-400 transition-colors"
          >
