...
const COMPONENT_META = {
  ...
  rpc: { label: 'Arbitrum RPC', icon: FiLink, detail: (m) => `block #${m.rpc?.blockNumber || '—'} · ${m.rpc?.latencyMs ?? 0}ms` },
...
const DevServiceStatus = () => {
  ...
  const incidents = useMemo(() => {
    const labelMap = { api: 'API', database: 'Database', rpc: 'Arbitrum RPC', workers: 'Workers', mpc: 'MPC' };
