...
<header><div><h1>Arbiter Invoice</h1><p class="muted">${inv.invoiceId}</p></div><div class="muted">Issued ${fmtWhen(inv.createdAt)}</div></header>
...
<p class="muted" style="margin-top:28px">Generated ${now.toLocaleString()} · Arbiter Developer Console</p></body></html>`;
