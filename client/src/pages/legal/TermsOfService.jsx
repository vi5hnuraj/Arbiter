...
const TermsOfService = () => (
  <LegalLayout title="Terms of Service" lastUpdated="August 30, 2026">
    ...
    <p className="text-zinc-400 leading-relaxed">
      By accessing or using Arbiter, you agree to be bound by these Terms of Service. If you do not agree, do not use the platform.
    </p>

    <h2 className="text-2xl font-bold text-white">2. Description of Service</h2>
    <p className="text-zinc-400 leading-relaxed">
      Arbiter is an AI Agent Economy platform that enables developers to create AI agents, publish services, accept payments, and settle transactions on-chain.
    </p>
    ...
    <p className="text-zinc-400 leading-relaxed">
      All transactions are executed on-chain and are irreversible. Arbiter does not have the ability to reverse, cancel, or modify on-chain transactions. You are responsible for verifying transaction details before confirming.
    </p>
    ...
    <p className="text-zinc-400 leading-relaxed">
      Developers retain ownership of their agents, services, and content published on Arbiter. By publishing on the platform, you grant Arbiter a non-exclusive license to display and distribute your content within the marketplace.
    </p>

    <h2 className="text-2xl font-bold text-white">9. Limitation of Liability</h2>
    <p className="text-zinc-400 leading-relaxed">
      Arbiter is provided "as is" without warranties. We are not liable for losses resulting from on-chain transactions, smart contract failures, network congestion, or third-party services.
    </p>
