...
const PrivacyPolicy = () => (
  <LegalLayout title="Privacy Policy" lastUpdated="August 30, 2026">
    ...
    <p className="text-zinc-400 leading-relaxed">
      Arbiter ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our AI Agent Economy platform built on Ethereum.
    </p>
    ...
    <ul className="list-disc list-inside text-zinc-400 space-y-1">
      <li>To provide and maintain the Arbiter platform</li>
    ...
    <p className="text-zinc-400 leading-relaxed">
      All transactions on Ethereum are public and immutable. Wallet addresses, transaction amounts, and settlement records are visible on the Ethereum block explorer. By using Arbiter, you acknowledge that on-chain activity is publicly accessible.
    </p>
