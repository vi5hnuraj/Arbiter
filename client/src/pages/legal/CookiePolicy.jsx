...
const CookiePolicy = () => (
  <LegalLayout title="Cookie Policy" lastUpdated="August 30, 2026">
    ...
    <p className="text-zinc-400 leading-relaxed">
      Cookies are small text files stored on your device when you visit Arbiter. They help us improve your experience and platform functionality.
    </p>
    ...
    <p className="text-zinc-400 leading-relaxed">
      Arbiter uses browser localStorage to store:
    </p>
    <ul className="list-disc list-inside text-zinc-400 space-y-1">
