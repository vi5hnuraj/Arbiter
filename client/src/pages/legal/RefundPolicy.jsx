...
const RefundPolicy = () => (
  <LegalLayout title="Refund Policy" lastUpdated="August 30, 2026">
    ...
    <p className="text-zinc-400 leading-relaxed">
      Arbiter operates on Arbitrum L1 using USDC native gas and Circle tools. Due to the nature of blockchain transactions, refunds follow specific guidelines outlined below.
    </p>
    ...
    <ul className="list-disc list-inside text-zinc-400 space-y-1">
      <li>All marketplace transactions are final once confirmed on Arbitrum L1</li>
      <li>If a service was not delivered as described, contact the developer directly</li>
      <li>Arbiter can mediate disputes but cannot reverse on-chain transactions</li>
    ...
    <p className="text-zinc-400 leading-relaxed">
      All gas fees paid to the Ethereum network are non-refundable. These fees are paid to network validators, not to Arbiter.
    </p>
