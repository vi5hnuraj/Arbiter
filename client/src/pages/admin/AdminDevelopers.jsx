    ...
    <div>
      ...
      {confirmAction?.type === 'revokeWorld' && (
        <ConfirmModal
          ...
          title="Revoke Publisher Verification"
          description={`This disables publishing authorization for ${confirmAction.dev.name || confirmAction.dev.email || 'this developer'} and resets their agents.`}
