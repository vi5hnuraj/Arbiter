...
const HelpCenter = () => {
  ...
  const faqs = [
    // Getting Started
    {
      ...
      question: 'What is Arbiter?',
      answer: 'Arbiter is an AI Agent Economy platform built on Arbitrum L1 and powered by Circle Agent Stack. It lets developers build AI agents, publish services, and accept payments in USDC — all with on-chain settlements and Circle MPC wallets.'
    },
    {
      category: 'getting-started',
    ...
    {
      category: 'getting-started',
      question: 'Do I need a crypto wallet to use Arbiter?',
      answer: 'No. Arbiter creates an internal MPC wallet for you automatically. You can also connect an external wallet (MetaMask, Rabby, etc.) if you prefer to manage your own keys.'
    },
    {
      category: 'getting-started',
      question: 'What is Arbitrum Sepolia?',
      answer: 'Arbitrum Sepolia is an Ethereum L2 testnet where Arbiter settles agent payments in USDC (as an ERC20 token) and pays gas in ETH. Chain ID: 421614.'
    },
    {
      category: 'getting-started',
      question: 'How do I add Arbitrum Sepolia to my wallet?',
      answer: 'Open MetaMask, Rabby, or Coinbase Wallet, and add: Network Name "Arbitrum Sepolia", RPC "https://sepolia-rollup.arbitrum.io/rpc", Chain ID "421614", Symbol "ETH". USDC is used as an ERC20 token for payments. You can also connect through the wallet button on any payment screen.'
    },

    // Wallets
    {
      category: 'wallets',
      question: 'What types of wallets does Arbiter support?',
      answer: 'Arbiter supports three wallet types: (1) Internal MPC Wallet — created automatically when you sign up, managed by the platform. (2) External Wallet — connect MetaMask, Coinbase Wallet, or any EVM wallet. (3) AI Agent Wallet — each agent you create gets its own dedicated wallet.'
    },
    {
      category: 'wallets',
      question: 'How do MPC wallets work?',
      answer: 'MPC (Multi-Party Computation) wallets split your private key into multiple shares across different servers. No single server holds the full key, so even if one is compromised, your funds remain safe. This allows Arbiter to sign transactions on your behalf without ever exposing your full private key.'
    },
    {
      category: 'wallets',
    ...
    {
      category: 'agents',
      question: 'What are AI Agents on Arbiter?',
      answer: 'AI Agents are autonomous programs you create on Arbiter using Circle Agent Stack. Each agent gets its own headless wallet, can discover and pay for services, enforce spending policies, and transact with other agents using USDC on Arbitrum.'
    },
    {
      category: 'agents',
    ...
    {
      category: 'billing',
      question: 'What fees does Arbiter charge?',
    ...
    },
    {
      ...
      answer: 'Yes. Every on-chain transaction requires a micro gas fee paid in ETH on Arbitrum Sepolia. Gas fees are ultra-low (fractions of a cent per transaction).'
    },
    ...
    // Security
    {
      ...
      answer: 'Arbiter uses MPC (Multi-Party Computation) wallets with distributed key shares. No single server holds your full private key. All transactions are signed through secure multi-party computation.'
    },
    {
      category: 'security',
    ...
    {
      category: 'security',
      question: 'Does Arbiter store my private keys?',
      answer: 'No. Private keys are split into shares using MPC and distributed across multiple secure servers. Arbiter never holds a complete private key.'
    },
    {
      category: 'security',
    ...
    },
    {
      ...
      answer: 'Go to Developer Console > Webhooks, add your endpoint URL, and select which events to subscribe to (e.g., payment.received, agent.invoked). Arbiter sends POST requests to your URL when those events occur.'
    },
    {
      category: 'developers',
      question: 'What blockchain does Arbiter use?',
      answer: 'Arbiter settles on Arbitrum Sepolia (Chain ID 421614), paying gas in ETH and USDC as an ERC20 via Arbiter. You can use standard Ethereum tools (ethers.js, viem, Hardhat, Foundry, AppKit) to interact with the chain.'
    },
    {
      category: 'developers',
      question: 'How do I deploy a smart contract on Arbitrum Sepolia?',
      answer: 'Add Arbitrum Sepolia to your wallet (RPC: https://sepolia-rollup.arbitrum.io/rpc, Chain ID: 421614), deploy using Foundry or Hardhat, and verify on sepolia.arbiscan.io. Get testnet USDC from faucet.circle.com.'
    },
    {
      category: 'developers',
      question: 'Is there a sandbox/test environment?',
      answer: 'Yes. Arbitrum Sepolia (Chain ID: 421614) is the active environment. Get testnet ETH from any Arbitrum Sepolia faucet and testnet USDC from Circle’s faucet at faucet.circle.com.'
    },
  ];
      ...
      <div className="pt-24 pb-12 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-zinc-400 text-sm sm:text-base max-w-lg mx-auto">
            Find answers to common questions about Arbiter, wallets, AI agents, billing, and more.
          </p>
      ...
      <div className="max-w-4xl mx-auto px-4 pb-20">
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 sm:p-8">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {/* Telegram */}
            <a
              href="https://t.me/ArbiterSupport"
              target="_blank"
            ...
            {/* Email */}
            <a
              href="mailto:support@arbiter.finance"
              className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-5 hover:border-emerald-500/30 transition-colors group"
            >
              <div className="w-10 h-10 bg-emerald-500/10 rounded-xl flex items-center justify-center mb-3">
              ...
              <p className="text-zinc-500 text-xs mb-3">support@arbiter.finance</p>
              <span className="text-emerald-400 text-xs font-medium flex items-center gap-1 group-hover:gap-2 transition-all">
