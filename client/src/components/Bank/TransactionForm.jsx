    ...
    <div className="bg-zinc-900 border-zinc-800 border-[1px] p-5 sm:p-8 rounded-2xl flex-1 shadow-2xl transition-all duration-300">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-zinc-500 text-sm mt-1">Send USDC instantly using Arbiter Tag or Wallet Address</p>
        </div>
      ...
      <div className="mb-8 p-4 bg-cyan-950/20 border-cyan-800/40 border rounded-xl flex items-center justify-between transition-colors">
        ...
        <div className="text-right">
          <p className="text-[10px] text-cyan-400 font-medium">Arbitrum Sepolia</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label htmlFor="senderUPI" className="block text-xs font-bold text-zinc-500 uppercase tracking-widest mb-2 ml-1">Your Arbiter Tag / Address</label>
