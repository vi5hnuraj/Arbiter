...
const TransactionHistory = ({ transactions, userData, onSuccess }) => {
  ...
  const handleCancel = useCallback(async (t) => {
    ...
    try {
      ...
      const contractAddress = import.meta.env.VITE_ARBITER_MANAGER_ADDRESS || '0x6b5BA9E3E8175eCfB8291FA0ee358b070c0522Cc';
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 shrink-0 ml-4">
                      ...
                      <div className="text-right">
                        ...
                        {hasValidTxHash(t) && (
                          <a
                            href={`${import.meta.env.VITE_EXPLORER_URL || 'https://sepolia.arbiscan.io'}/tx/${t.txHash.trim()}`}
                            target="_blank"
                            rel="noreferrer"
