    ...
    <div className="bg-zinc-900 border border-zinc-800 p-4 rounded-xl flex flex-col sm:flex-row items-center justify-between shadow-lg mb-6 gap-4 font-sans">
      <div className="flex items-center gap-4">
        <div>
          ...
          <p className="text-xs text-zinc-500 mt-1">Arbitrum Stablecoin Payment Rails</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <button
          onClick={() => copyToClipboard(globalPayTag, 'Arbiter Tag')}
        ...
        >
          {copied === 'Arbiter Tag' ? <FiCheck size={14} className="text-emerald-400" /> : <FiCopy size={14} />}
          Copy Tag
        </button>
      </div>
