...
export const environment = (_req, res) => {
  res.json({
    ...
    rpcUrl: process.env.ARC_RPC_URL || process.env.RPC_URL || 'https://sepolia-rollup.arbitrum.io/rpc',
    explorerUrl: process.env.ARC_EXPLORER_URL || process.env.EXPLORER_URL || 'https://sepolia.arbiscan.io/',
