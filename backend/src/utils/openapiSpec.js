/**
 * OpenAPI 3.0 specification for the Arbiter AI Agent Platform.
 * Served at GET /api/openapi.json and referenced from the developer docs.
 */

const SERVER_URL = process.env.PUBLIC_API_URL || process.env.VITE_API_URL || 'https://api.arbiter.dev';

export const openapiSpec = {
  openapi: '3.0.3',
  info: {
    title: 'Arbiter API — Bank for Bots',
    version: '1.1.0',
    description:
