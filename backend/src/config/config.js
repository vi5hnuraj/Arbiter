...
export const ARC_CHAIN_ID = Number(process.env.ARC_CHAIN_ID || process.env.CHAIN_ID || 421614); // Base Sepolia
export const ARC_RPC_URL = process.env.ARC_RPC_URL || process.env.RPC_URL || 'https://sepolia-rollup.arbitrum.io/rpc';
export const ARC_EXPLORER_URL = process.env.ARC_EXPLORER_URL || process.env.EXPLORER_URL || 'https://sepolia.arbiscan.io/';
...
// Platform fees — commission Arbiter keeps from every transaction.
