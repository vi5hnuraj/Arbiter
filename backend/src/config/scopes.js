 ...
 * V3 scopes (noun.verb format) are the canonical Arbiter V3 permission
...
/**
 * V3 Scope Catalog — canonical Arbiter V3 permission scopes.
 ...
 * even though the permissions mean the same thing. Arbiter V3 collapses the
