...
/**
 * Arbiter x The Graph MCP Server
 * ==================================
 * Model Context Protocol server that exposes Arbiter's live The Graph
 ...
 *
 * An MCP tooling server exposing The Graph data to AI agents.
 */
...
const tools = {
  analyze_provider: {
    description: 'Get The Graph trust/risk analysis for a provider wallet address on Arbiter',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  ask_trust_engine: {
    description: 'Query Arbiter\'s on-chain trust data indexed by The Graph in natural language',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  graph_status: {
    description: 'Get the current status of Arbiter\'s The Graph subgraph deployment',
    inputSchema: {
      type: 'object',
      properties: {}
    },
