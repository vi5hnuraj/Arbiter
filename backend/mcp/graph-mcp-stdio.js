...
/**
 * Standards-compliant MCP stdio server for Arbiter's live Graph intelligence.
...
const server = new McpServer({ name: 'arbiter-graph-intelligence', version: '1.0.0' });

server.registerTool('graph_status', {
  title: 'Arbiter Graph Status',
  description: 'Return live sync and indexed payment status from the Arbiter Arc Subgraph.',
  inputSchema: {}
}, async () => {
