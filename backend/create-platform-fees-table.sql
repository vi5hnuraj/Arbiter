-- Platform Fees Table
-- Tracks all commission fees collected by Arbiter from marketplace transactions
...
COMMENT ON COLUMN platform_fees.platform_fee_wei IS 'The commission amount in wei that goes to Arbiter treasury';
